<script lang="ts">
  /** Minimal line-icon set (Feather-style: 24px grid, round caps). */
  interface Props {
    name: string
    size?: number
    strokeWidth?: number
  ...
  let { name, size = 22, strokeWidth = 1.75, label }: Props = $props()

  const paths: Record<string, string> = {
    layers: 'M12 2 2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5',
    help: 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18zM9.1 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3M12 17h.01',
    ...
    flip: 'M23 4v6h-6M1 20v-6h6M3.5 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.65 4.36A9 9 0 0 0 20.5 15',
  ...
  // icons drawn as a solid fill (logos) rather than the stroke set
